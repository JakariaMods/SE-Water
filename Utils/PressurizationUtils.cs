...
namespace Jakaria.Utils
{
    ...
    public static class PressurizationUtils
    {
        // update this code when changed in game.
        ...
        public static bool IsAirtightBetweenPositions(this IMyCubeGrid grid, Vector3I startPos, Vector3I endPos)
        {
